...
$GLOBALS['TL_LANG']['tl_banner_category']['banner_default']       = array('Banner Standarddatei', 'Wenn Sie diese Option w&auml;hlen, k&ouml;nnen Sie eine Bannerdatei ausw&auml;hlen die angezeigt wird, wenn kein Banner in der Kategorie aktiv ist.<br />Eine Auswahl hat Vorrang vor der Modul Definition "Ausblenden, wenn leer".');
...
$GLOBALS['TL_LANG']['tl_banner_category']['banner_numbers']       = array('Alle Banner anzeigen', 'Wenn Sie diese Option w&auml;hlen, werden alle aktiven Banner der Kategorie angezeigt im Frontend.');
